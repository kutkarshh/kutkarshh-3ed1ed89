...
const Contact = () => {
  ...
  const contactLinks = [
    ...
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      value: "linkedin.com/in/kutkarshh",
      href: profile.linkedin,
    },
    {
      icon: Github,
      label: "GitHub",
      value: "github.com/kutkarshh",
      href: profile.github,
    },
  ];
          ...
          >
            ...
            >
              ...
              <Button
                ...
                className="w-full bg-gradient-primary hover:opacity-90 transition-opacity text-white py-6 text-lg"
              >
                {isSubmitting ? (
                  "Sending..."
                ) : (
